...
public class Test_A07_TreasureMap {
    private String SITNETID = Test_A07_TreasureMap.class.getCanonicalName().split("\\.")[1];
    ...
    private void oneTestGoodParseDirection(TreasureMap m,
        ...
        Assert.assertEquals(m.getMapString(), expectedMap);
    }
    ...
    private void oneTestGoodSave(TreasureMap m,
        ...
        try (
            ...
            Assert.assertEquals(data, m.getMapString());
        }
        catch(Exception e) {
            throw new AssertionError("Should NOT throw exception!", e);
        }
